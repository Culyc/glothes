(() => {
  ...
  const N = {
    ...
    updateSlides: function () {
      ...
      for (let n = 0; n < p; n += 1) {
        ...
        const a = c.eq(n);
        if (
          (S && e.grid.updateSlide(n, a, p, t), "none" !== a.css("display"))
        ) {
  ...
  function ue(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (r.find(pe(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          r.find(pe(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    function p() {
      ...
      if ("bullets" === e.type) {
        ...
        i.html(r), (t.pagination.bullets = i.find(pe(e.bulletClass)));
      }
      "fraction" === e.type &&
        ((r = e.renderFraction
        ...
        if (s.params.autoplay.enabled) {
          ...
          h().addEventListener("visibilitychange", c),
            s.params.autoplay.pauseOnMouseEnter &&
              (s.$el.on("mouseenter", u), s.$el.on("mouseleave", m));
        }
      }),
  ...
  setTimeout(() => {
    ...
    ymaps.ready(function () {
      new ymaps.Map("map", { center: [55.751574, 37.573856], zoom: 9 });
    }),
    console.log("2"),
    (window.FLS = !0),
    (function (e) {
    ...
    (function () {
      ...
      function o(s, i) {
        s.forEach((s) => {
          !(function (s, i = !1) {
            const n = (s = i ? s.item : s).querySelector(
                "[data-showmore-content]"
              ),
              r = s.querySelector("[data-showmore-button]"),
              a = l(s, n);
            (i.matches || !i) &&
            a <
              (function (e) {
      ...
      function d(s) {
        ...
        if ("click" === d) {
          if (a.closest("[data-showmore-button]")) {
            const s = a
              ...
              n = s.dataset.showmoreButton ? s.dataset.showmoreButton : "500",
              r = l(s, i);
        ...
        } else "resize" === d && (i.length && o(i), n.length && r(n));
      }
      s.length &&
